...
public class Main {
    public static void main(String[] args){
        ...
        doOperation("Print ", buffer, (b)-> System.out.printf(b+" "));
        ...
        doOperation("Flip (Read to Write) ", buffer, ByteBuffer::flip);
...
//        doOperation("2. Change limit to capacity", buffer, b-> b.limit(b.capacity()));
        ...
        doOperation("Append ", buffer, b->b.put(" This is new text".getBytes()));
